	...
	<g:each in="${layout}" var="layoutRow">
		<tr class="columnprop">
			...
			<td valign="top" class="columnvalue">
				<g:if test="${layoutRow.dataType.toLowerCase() == 'date'}">
					<g:fieldDate bean="${file}" field="${layoutRow.column}" format="yyyy-MM-dd"/>
				</g:if>
				<g:elseif test="${layoutRow.dataType.toLowerCase() == 'datasize'}">
					<g:fieldBytes bean="${file}" field="${layoutRow.column}"/>
				</g:elseif>
				<g:elseif test="${layoutRow.dataType.toLowerCase() == 'prestring'}">
