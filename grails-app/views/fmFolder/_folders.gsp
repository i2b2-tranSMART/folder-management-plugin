...
def ontologyService = grailsApplication.mainContext.ontologyService
def fmFolderService = grailsApplication.mainContext.fmFolderService
%>
		...
		<tr>
			<td class="foldertitle">
				...
				<a href="#" onclick="${showDetailDialogJsFunc}">
					...
					<span id="result-folder-name-${folder.id}" class="result-folder-name ${highclass} accLev_${folderAccessLevel}" title="${folder.folderName}">${folder.folderName}</span>
				</a>
			</td>
		</tr>
